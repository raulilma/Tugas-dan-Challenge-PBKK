...
<head>
    ...
    <title>Tambah Game dan Studio Multiple</title>
            ...
            <div class="row page-bg">
                <div class="p-4 col-md-12">
                    <div class="text-center top-icon">
                        <h1 class="mt-3">Tambah Game dan Studio Multiple</h1>
                        <br>
                        ...
                        <form id="form-login" action="{{ route('studio.buat-multiStudio') }}" method="post">
                            @csrf
